...
const SectionTitle = ({ title, subtitle }) => (
  ...
  >
    ...
    {subtitle ? <p className="mt-4 text-[#A3A3A3] text-sm md:text-base leading-7">{subtitle}</p> : null}
  </motion.div>
);
...
const PartnerDemoExperience = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050506] text-[#FAFAFA] overflow-x-hidden">
      ...
      <section className="relative z-10 min-h-[72vh] md:min-h-screen px-4 md:px-10 py-12 md:py-20 flex items-center">
        <div className="max-w-6xl mx-auto text-center">
          <motion.p
            ...
            className="text-[11px] sm:text-xs tracking-[0.18em] uppercase text-[#A3A3A3] mb-3"
          >
          ...
          <motion.p
            ...
            className="mt-4 md:mt-6 text-sm sm:text-base md:text-xl text-[#A3A3A3] max-w-2xl md:max-w-3xl mx-auto leading-6 sm:leading-7 md:leading-8"
          >
          ...
          {!isMobile ? (
            <motion.div animate={{ y: [0, 8, 0], opacity: [0.5, 1, 0.5] }} transition={{ duration: 1.6, repeat: Infinity }} className="mt-14 inline-flex flex-col items-center text-[#A3A3A3]">
      ...
      <section className="relative z-10 px-4 md:px-10 py-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div className={`${cardClass} p-6 md:p-8`}>
            ...
            <p className="mt-4 text-[#C4C4C4] leading-7">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
          {[
            ...
            <motion.div key={title} initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }} className={`${cardClass} p-6`}>
              ...
              <p className="mt-2 text-[#A3A3A3] text-sm">{text}</p>
            </motion.div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <motion.div key={label} whileHover={{ y: -4 }} className={`${cardClass} p-5`}>
              ...
              <p className="text-[#A3A3A3] text-sm mt-2">{label}</p>
      ...
      <section className="relative z-10 px-4 md:px-10 py-16">
        ...
        <div className="max-w-7xl mx-auto mt-8 flex flex-wrap gap-3 justify-center">
          ...
          <Button variant="outline" className="rounded-xl border-white/20 text-white hover:bg-white/10 min-h-11" onClick={simulateRedemption}>Simulate Reward Redemption</Button>
          <Button variant="outline" className="rounded-xl border-white/20 text-white hover:bg-white/10 min-h-11" onClick={simulateCampaign}>Simulate Campaign Launch</Button>
        </div>
      </section>
      ...
      <section className="relative z-10 px-4 md:px-10 py-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className={`${cardClass} p-5`}>
            ...
            <p className="text-[#A3A3A3] text-sm mt-2">Visit frequency and engagement patterns.</p>
          ...
          <div className={`${cardClass} p-5`}>
            ...
            <p className="text-[#A3A3A3] text-sm mt-2">How customers move between partner businesses.</p>
            <div className="relative min-h-[280px] mt-4 rounded-xl border border-white/10 overflow-hidden">
              {[
                ['Cafe', '18%', '18%'],
                ['Gym', '28%', '62%'],
                ['Restaurant', '62%', '26%'],
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <motion.div key={title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.07 }} whileHover={{ y: -5, scale: 1.01 }} className={`${cardClass} p-5`}>
              ...
              <p className="text-xs mt-2 text-[#A3A3A3]">{desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="relative z-10 px-4 md:px-10 py-20">
        <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`${cardClass} max-w-5xl mx-auto p-10 border border-[#14B8A6]/40 text-center`}>
          ...
          <div className="mt-8">
            <Button className="rounded-xl min-h-11 px-6 bg-[#3B82F6] hover:bg-[#2b71e8]">
              Get Started Today
